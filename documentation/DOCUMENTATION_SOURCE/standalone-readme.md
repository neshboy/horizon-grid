...
- **AI-assisted analysis, twice per investigation** — a short summary per provider as each one reports in, then one consolidated Final Assessment once every provider has finished, on your choice of five interchangeable AI backends. See "AI Capabilities" below.
