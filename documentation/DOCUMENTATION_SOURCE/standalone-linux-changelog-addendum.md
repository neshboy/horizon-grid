...
- Added a first-class Linux release: `horizon-grid_0.3.8_amd64.deb` (~6.2 MB), version 0.3.8 matching Windows exactly, tested on Ubuntu 24.04 LTS, Ubuntu 22.04 LTS, and Debian 12 (bookworm).
