...
![Version](https://img.shields.io/badge/version-0.3.7-brightgreen)
...
`horizon-grid_<version>_amd64.deb`, e.g. `release/horizon-grid_0.3.7_amd64.deb`).
Install with `sudo dpkg -i horizon-grid_0.3.7_amd64.deb`, then run the
