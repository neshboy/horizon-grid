...
| 15 | Admin lockout protection, no insecure backdoor | **By design, disclosed** | No universal backdoor exists or was added. Recovery from a fully-locked-out state requires direct database access — documented as a real, accepted limitation in §5 of the Mission-Critical Operations Manual, not silently unaddressed. |
